/*
 *
 *	xclibex4.cpp	External	16-Feb-2023
 *
 ...
 */
  ...
  *	E1, E1DB, E4, E4DB, E4G2, E4TX2, E8, E8CAM, E8DB, e104x4, EB1, EB1G2, EB1-POCL, EB1G2-POCL, EB1mini,
  *	miniH2B, miniH2F, miniH2x4F, mf2280, EC1, ECB1, ECB1-34, ECB2, EL1, EL1DB, ELS2, SI, SI1, SI2, and SI4
...
#include FORMATFILE_COMP
		...
		// Set our title.
		//
		SetWindowText(hDlg, "Jordan's Attempt at a PIXCI System");
		...
		// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		// Now for My go!
		EnableWindow(GetDlgItem(hDlg, FUNNYBUTTON), TRUE);
		EnableWindow(GetDlgItem(hDlg, RUNBUTTON), TRUE);
